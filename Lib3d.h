...
void GUIDrawFeuille(FeuilleCarte f, FeuilleCarte temp, Model mountains[], Position mountainPos[NOMBREMONTAGNE], Image treeImage, ModelList models);
...
int GUIPlacementCard(GameState* gs, FeuilleCarte f, const ExploreCard* card, int score, int isRuin, int* coinCount, Camera3D camera, Model mountains[NOMBREMONTAGNE], Image forestImage, ModelList models);
